...
evaluations, never forming the full array~\cite{Oseledets2010}. It is
...
\begin{itemize}
  ...
  \item \textbf{Rank-adaptive variants} insert pivots where the local error is
    largest, rather than fixing $\chi$ in advance~\cite{Nunez2025}.
...
\begin{itemize}
  ...
  \item \textbf{Escaping local minima.} Two-site updates explore directions
    ...
    with residual directions~\cite{Dolgov2014,Holtz2012}.
